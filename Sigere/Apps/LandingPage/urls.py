...
urlpatterns = [
    ...
    path('resenas/', ReviewDashboardView.as_view(), name='resenas_dashboard'),
    path('resenas/nueva/<int:reserva_id>/', ReviewCreateView.as_view(), name='resena_crear'),
    path('resenas/<int:pk>/eliminar/', ReviewDeleteView.as_view(), name='resena_eliminar'),
